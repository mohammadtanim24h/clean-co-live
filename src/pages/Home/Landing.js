            ...
            <div class="hero h-screen lg:h-[60vh] bg-accent">
                <div class="hero-content flex-col-reverse lg:flex-row-reverse">
                    ...
                    <div>
                        ...
                        <h1 data-aos="fade-right" data-aos-delay="300" data-aos-duration="900" class="text-5xl font-bold">Professional Cleaning Service</h1>
                        <p data-aos="fade-right" data-aos-delay="400" data-aos-duration="800" class="py-6 max-w-xl">
                            Provident cupiditate voluptatem et in. Quaerat
                            fugiat ut assumenda excepturi exercitationem quasi.
                            In deleniti eaque aut repudiandae et a id nisi.
                        </p>
                        <button data-aos="zoom-in" data-aos-delay="900" data-aos-duration="800" class="btn btn-primary">Get Started</button>
                    </div>
                </div>
            </div>
            {/* Free Estimate */}
